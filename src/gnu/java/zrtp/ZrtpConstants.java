...
//        (byte)0x44, (byte)0x48, (byte)0x34, (byte)0x6b};        // "DH4k"
    ...
    public enum SupportedPubKeys {
        ...
        E255(e255, 32, new Djb25519KeyGenerationParameters(_secureRandomGenerator)),

        DH2K(dh2k, 256, new DHKeyGenerationParameters(_secureRandomGenerator,
                specDh2k)),
        DH3K(dh3k, 384, new DHKeyGenerationParameters(_secureRandomGenerator,
                specDh3k)),
        MULT(mult);
